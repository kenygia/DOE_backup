...
class Scierie extends Batiment
{    
  ...
  { 
		...
		$this->_prixConstruction=array('Bois' =>(int)$lvl*3,'Or'=>(int)$lvl*2 );
        $this->_tmpConstruction=pow((int)$lvl,2);
		$this->_race=1;
		$this->_representation=' <img src="img/warehouse.svg" border="0"/> ';
    $this->_lvlMax=5;
  }
    elseif($lvl < 0)
  {
        ...
        <td>
        	<table border =4 cellspacing=4 cellpadding=4 widh=80%>
        		<tr>
        			...
        			<td> production : <img src=\"img/bois.png\" width=\"40\"/> </td>
           		</tr>
        		<tr>
